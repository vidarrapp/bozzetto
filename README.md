...
- **DoF Controls and focus** — You can now set the focus using alt+left click directly on the model (or a double-tap on touch devices), rather than using the slider in the panel.
...
| Alt + click *(or double-tap on touch)* | Set focus point (tap-to-focus) |
| `1` | Lit (PBR) |
| `2`… | Matcaps |
