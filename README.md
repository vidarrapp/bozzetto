...
- **DoF Controls and focus** — You can now set the focus by double-clicking or alt+left clicking directly on the model (or a double-tap on touch devices), rather than using the slider in the panel.
...
| Double-click / Alt + click *(double-tap on touch)* | Set focus point (tap-to-focus) |
| `1` | Lit (PBR) |
| `2`… | Matcaps |
