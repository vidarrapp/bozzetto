...
- **Touch toolbar** — a bottom bar for keyboard-less iPads: a hold-to-carve Negative button in the left corner (strokes carve while it's held, like holding `Alt`; sculpt with a second finger) and the nine brushes as numbered buttons synced with the hotkeys. Icons come later.
